...
/**
 * An interface to a collection of values of
 * type string|int|float|bool|null|object|array.
 *
 * @author pajurancodes
 */
interface StandardCollectionInterface extends \Countable, \IteratorAggregate {
